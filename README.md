# 2027 届校园招聘聚合站（央国企、外企及各类企业）

每天从企业官网、官方招聘平台和可验证的官方公众号公开页面采集 2027 届正式校园招聘公告，覆盖央国企、外企、民企及其他各类企业，生成可筛选的静态网站、JSON 和 CSV，并部署到 GitHub Pages：
...
- 主站只发布 sources.yaml 注册企业的官方域名链接；搜索结果先写入 data/leads.json 作为内部线索，核验企业官方域名后才会公开。
- 央国企集团总部可全国收录；二、三级子公司仅允许登记位于广西南宁的主体，且公告必须明确指向南宁。其他地区子公司不会进入公开数据。
- 注册表采用开放式企业目录，包含央国企、外企、民企及其他企业；任何新开启 2027 届校招的企业，只要登记可验证的官方域名和招聘入口即可进入监测。央企子公司可通过母公司官方渠道或国资委官网单独收录。
